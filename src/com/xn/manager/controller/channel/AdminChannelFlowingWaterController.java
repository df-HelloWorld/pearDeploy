...
/**
 * @ClassName:
 * @Description: 管理员-渠道资金流水的Controller层
 * @Author: yoko
 * @Date: $
 * @Version: 1.0
 **/
@Controller
@RequestMapping("/adminchannelflowingwater")
public class AdminChannelFlowingWaterController extends BaseController {
    private static Logger log = Logger.getLogger(AdminChannelFlowingWaterController.class);
    ...
    @RequestMapping("/list")
    public String list() {
        return "manager/adminchannelflowingwater/adminchannelflowingwaterIndex";
    }
...
//                }
            ...
            dataList = channelFlowingWaterService.queryByList(model);
        }
    ...
    public void exportData(HttpServletRequest request, HttpServletResponse response, ChannelFlowingWaterModel model) throws Exception{
        ...
        if(account !=null && account.getId() > ManagerConstant.PUBLIC_CONSTANT.SIZE_VALUE_ZERO){
            ...
            titles = new String[]{"平台订单",      "商家订单",   "渠道名称",     "平台通道码名称", "通道名称",  "通道码名称",     "订单金额",     "手续费",       "类型",           "原金额",   "变动金额",   "变动后金额",   "备注",   "变动时间"};
            titleCode = new String[]{"myTradeNo", "outTradeNo",  "channelName",  "codeName",      "gewayName",  "gewayCodeName", "totalAmount", "serviceCharge",  "changeTypeStr",  "oldMoney", "changeMoney","newMoney",    "remark",  "createTime"};
