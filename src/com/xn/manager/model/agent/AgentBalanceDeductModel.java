...
/**
 * @Description 代理扣减余额流水表的实体属性Bean
 * @Author yoko
 * @Date 2020/10/31 16:19
 * @Version 1.0
 */
public class AgentBalanceDeductModel extends BasePage implements Serializable {
    private static final long   serialVersionUID = 1273223202106L;

    public AgentBalanceDeductModel(){
