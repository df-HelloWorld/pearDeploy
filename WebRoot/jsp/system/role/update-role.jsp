						...
						<ul>
							...
							<li>
								<div class="" style="margin-bottom: 20px; margin-top: 20px;text-align:center;">
									<input type="submit" class="formBtn" style="color: #1094fa" value="修 改" /> <span>
									</span> <input type="reset" style="color: #1094fa" class="formBtn" value="重  置" />
									<input type="button" style="color: #1094fa" onClick="javascript :history.back(-1);" class="formBtn" value=" 返 回 " />
								</div>
							</li>
						</ul>
					</form>
