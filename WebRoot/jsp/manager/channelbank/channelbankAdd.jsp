    ...
    <div class="formContentDiv">
        <form id="addSupplierForm">
            <ul>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require">开户省份</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="province" name="province"	maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require">开户城市</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="city" name="city"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("添加成功！！！");
                            window.location.href = ctx + "/channelbank/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
