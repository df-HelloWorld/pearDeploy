        ...
        <form id = "condForm">
            <div class = "condQueryCtrl">
                ...
                <div class="formCtrlDiv">
                    <input type ="text" class ="inputCommonSty" id="agentName" name ="agentName">
                </div>
...
<div id="show" style="display:none;width:500px;">
    <div class="formHeadDiv">
        <h2>
            <span><font color="red">代理提现审核</font></span>
        </h2>
    </div>
        ...
        <form id="newFirstStoreForm">
            ...
            <dl>
                ...
                <dd style="border-top: none;">
                    ...
                    <div class="formCtrlDiv" style="width: 200px;margin-left: 10px;">
                        <input type="text" style="width: 200px;box-sizing: border-box" class="formInput"
                               id="divAgentName" name="divAgentName" disabled="disabled"/>
                    </div>
                </dd>
...
<script type='text/javascript' charset="utf-8" src='${ctxData}js/manager/adminagentwithdraw/adminagentwithdraw.js'></script>
</body>
</html>
<style>
