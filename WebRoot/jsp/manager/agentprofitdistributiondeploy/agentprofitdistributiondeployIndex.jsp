...
<div class="col_main">
    ...
    <table class="datatable tables">
        <thead>
        <tr>
            <th width="150">利益名称</th>
            <th width="150">绑定类型</th>
            <th width="150">渠道</th>
            <th width="150">通道</th>
            <th width="200">代理+费率</th>
            <th width="200">备注</th>
            <th width="180">操作</th>
        </tr>
        </thead>
...
<script type='text/javascript' charset="utf-8" src='${ctxData}js/manager/agentprofitdistributiondeploy/agentprofitdistributiondeploy.js'></script>
</body>
</html>
