            ...
            <ul>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <select id="bindingType" name="bindingType" onchange="changeBindingType()" >
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>利益名称：</span>
                    </div>
                    <div class="formCtrlDiv">
...
<script type='text/javascript'>
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    url : ctx+ "/agentprofitdistributiondeploy/add.do",
                    type : 'post',
                    dataType : 'json',
                    data :formData,
                    success : function(data) {
                        if (data.success) {
                            alert("添加成功！！！");
                            window.location.href = ctx + "/agentprofitdistributiondeploy/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
    ...
    function changeBindingType() {
        var bindingType=$("#bindingType").val();
        if(1==bindingType){
            $("#channelId").attr("disabled","disabled");
        }else{
            $("#channelId").selected=true;
        }
    }
    // function  queryChannelAll(){
    //     var url = ctx +"/adminchannel/dataAllList.do";
    //     var data = {
    //     };
