            ...
            <ul>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>名称：</span>
                    </div>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" >通道码：</span>
                    </div>
                    <div class="formCtrlDiv">
                        <select id="gewayCodeId" name="gewayCodeId" >
                            <option value="">===请选择===</option>
                            <c:forEach items="${pfGewayCode}" var="dataList">
                                <c:choose>
                                    <c:when test="${dl.gewayCodeId == dataList.id}">
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <select id="bindingType" name="bindingType" >
                            <option value="">===请选择===</option>
                            <c:if test="${dl.bindingType == 1}">
                                <option value="1" selected="selected">通道码绑定</option>
                                <option value="2">渠道绑定</option>
                                <option value="3">两者绑定</option>
                            </c:if>
                            <c:if test="${dl.bindingType == 2}">
                                <option value="1">通道码绑定</option>
                                <option value="2" selected="selected">渠道绑定</option>
                                <option value="3">两者绑定</option>
                            </c:if>
                            <c:if test="${dl.bindingType == 3}">
                                <option value="1">通道码绑定</option>
                                <option value="2">渠道绑定</option>
                                <option value="3" selected="selected">两者绑定</option>
                            </c:if>
                        </select>
                    </div>
                </li>
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("修改成功！");
                            window.location.href = ctx + "/adminagentprofitdistribution/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
