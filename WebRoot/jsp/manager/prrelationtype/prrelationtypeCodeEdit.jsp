            ...
            <ul>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <select id="pfGewayCodeId" name="pfGewayCodeId" class='text-input medium-input' >
                        ...
                        <c:forEach items="${platformGewayCode}" var="dataList">
                            <c:choose>
                                <c:when test="${selPlatformGewayCode == dataList.id}">
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    url : ctx+ "/prplatformgewaycode/insertPfGewayCode.do",
                    type : 'post',
                    dataType : 'json',
                    data :formData,
