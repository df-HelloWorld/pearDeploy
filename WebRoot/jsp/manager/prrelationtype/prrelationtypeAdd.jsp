            ...
            <ul>
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="typeName" name="typeName"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                ...
                <%--<li style="border-top: none;">--%>
                    <%--<div class="formTextDiv">--%>
                        <%--<span class="require"><font color="red">*</font>平台通道编码：</span>--%>
                    <%--</div>--%>
                    <%--<div class="formCtrlDiv">--%>
                        <%--<select id="gewayId" name="gewayId" class='text-input medium-input' >--%>
                        <%--<option value="">===请选择===</option>--%>
                        <%--<c:forEach items="${platformGewayCode}" var="dataList">--%>
                        <%--<option value="${dataList.id}">${dataList.codeName}</option>--%>
                        <%--</c:forEach>--%>
                        <%--</select>--%>
                        <%--&lt;%&ndash;<input type="text" class="formInput" id="gewayCode" name="gewayCode"	maxlength="240" />&ndash;%&gt;--%>
                    <%--</div>--%>
                <%--</li>--%>
                ...
                <%--<li style="border-top: none;">--%>
                    ...
                    <%--<div class="formCtrlDiv">--%>
                        ...
                        <%--</div>--%>
                        <%--&lt;%&ndash;<select id="gewayId" name="gewayId" class='text-input medium-input' >&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<option value="">===请选择===</option>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<c:forEach items="${geway}" var="dataList">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<c:if test="${dataList.length/2}==0">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;1&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<c:if test="${dataList.length/2}==0">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;1&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<option value="${dataList.id}">${dataList.gewayName}</option>&ndash;%&gt;--%>
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            messages: {
                ...
                // stgType:{
                //     required:"秘钥key不能为空!",
                //     number:"秘钥key长度最多是200个字符!"
                // },
                // stgKey:{
                //     required:"商铺号不能为空!",
                //     number:"商铺号长度最多是20个字符!"
                // }
            },
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("添加成功！！！");
                            window.location.href = ctx + "/prrelationtype/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
