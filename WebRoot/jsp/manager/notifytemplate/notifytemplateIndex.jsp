...
<div class="col_main">
    ...
    <table class="datatable tables">
        ...
        <tr>
            ...
            <th width="150">模板</th>
            <th width="150">通道</th>
            <th width="160">接收数据方式</th>
            <%--<th width="160">返回数据类型</th>--%>
            <th width="160">check的参数名</th>
            <th width="160">check的参数值</th>
            <%--<th width="180">check的数据类型</th>--%>
            <th width="150">成功tag</th>
            <%--<th width="150">失败tag</th>--%>
