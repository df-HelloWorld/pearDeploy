...
<body onload="loadNotifyFieldUpdate()">
<div class="col_main">
    ...
    <div class="formContentDiv">
        <form id="addSupplierForm">
            <ul>
                <c:set var="notifyTemplate" value="${notifyTemplate}"/>
                    <input type="hidden" id="mbId" name="mbId" value="${notifyTemplate.id}">
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="template" name="template"	maxlength="240" value="${notifyTemplate.template}" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <select id="gewayCodeId" name="gewayCodeId" >
                            ...
                            <c:forEach items="${prGewayCode}" var="dataList">
                                <c:choose>
                                    <c:when test="${notifyTemplate.gewayCodeId == dataList.id}">
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>check的参数名</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="parameterName" name="parameterName"	maxlength="240" value="${notifyTemplate.parameterName}" />
                    </div>
                </li>

                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>check的参数值</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="parameterValue" name="parameterValue"	maxlength="240" value="${notifyTemplate.parameterValue}" />
                    </div>
                </li>

                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>check的数据类型：</span>
                    </div>
                    <div class="formCtrlDiv">
                        <select id="parameterValueType" name="parameterValueType">
                            <option value="">===请选择===</option>
                            <c:if test="${notifyTemplate.parameterValueType == 1}">
                                <option value="1" selected="selected">String类型</option>
                                <option value="2">Int类型</option>
                                <option value="3">Long类型</option>
                            </c:if>
                            <c:if test="${notifyTemplate.parameterValueType == 2}">
                                <option value="1">String类型</option>
                                <option value="2" selected="selected">Int类型</option>
                                <option value="3">Long类型</option>
                            </c:if>
                            <c:if test="${notifyTemplate.parameterValueType == 3}">
                                <option value="1">String类型</option>
                                <option value="2">Int类型</option>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>成功tag</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="sucTag" name="sucTag"	maxlength="240" value="${notifyTemplate.sucTag}" />
                    </div>
                </li>

                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>失败tag</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="failTag" name="failTag"	maxlength="240" value="${notifyTemplate.failTag}" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require">同步数据案例：</span>
                    </div>
                    <div class="formCtrlDiv">
                        <textarea id="notifyCase" name="notifyCase" cols="40" rows="5">${notifyTemplate.notifyCase}</textarea>
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <textarea id="remark" name="remark" cols="40" rows="5">${notifyTemplate.remark}</textarea>
                    </div>
                </li>
        ...
        <form id="addSupplierFormTwo">
            ...
            <%--<div class="formTextDiv" style="width: 100%;" id="notifyFieldDiv">--%>
...
<script type='text/javascript' charset="utf-8" src='${ctxData}js/manager/notifytemplate/notifytemplate.js'></script>
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            messages: {
                ...
                parameterName:{
                    required : "check的参数名不能为空!"
                },
                parameterValue:{
                    required : "check的参数值不能为空!"
                },
                parameterValueType:{
                    required : "check的数据类型不能为空!"
                },
                sucTag:{
                    required : "成功tag不能为空!"
                },
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    url : ctx+ "/notifytemplate/update.do",
                    type : 'post',
                    dataType : 'json',
                    data :{
                        dataOne:dataOne,
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("更新成功！！！");
                            window.location.href = ctx + "/notifytemplate/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
