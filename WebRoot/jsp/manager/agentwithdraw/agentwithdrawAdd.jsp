    ...
    <div class="formContentDiv">
        ...
        <form id="addSupplierForm">
            ...
            <ul>
                ...
                <h3><font color="red">从我的银行卡中选择，或者临时填写银行信息，任意选择其中一种形式就行</font></h3>


                <h5>银行卡选择</h5>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" >从我的银行卡选择</span>
                    </div>
                    <div class="formCtrlDiv">
                        <select id="agentBankId" name="agentBankId" >
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" >银行支行名称</span>
                    </div>
                    <div class="formCtrlDiv">
                ...
                <li>
                    <div class="" style="margin-bottom: 20px; margin-top: 20px;margin-left:200px;">
                        <input id="submitid" type="submit" class="buttonClass imginput" value="添  加" style="background-color: #54D8FE;" /> <span>
...
<script type='text/javascript' charset="utf-8" src='${ctxData}js/manager/agentwithdraw/agentwithdraw.js'></script>
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("添加成功！！！");
                            window.location.href = ctx + "/agentwithdraw/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
