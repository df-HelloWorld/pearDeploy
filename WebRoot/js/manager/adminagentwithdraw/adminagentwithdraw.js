...
var account = {
    //地址
    url:{
        list_url : ctx + '/adminagentwithdraw/list.do',
        dataList_url : ctx + "/adminagentwithdraw/dataList.do",
        add_url : ctx+ "/adminagentwithdraw/add.do",
        update_url : ctx+ "/adminagentwithdraw/update.do",
        queryId_url: ctx+ "/adminagentwithdraw/getId.do",
        delete_url: ctx+ "/adminagentwithdraw/delete.do",
        manyOperation_url: ctx+ "/adminagentwithdraw/manyOperation.do",
        check_url: ctx+ "/adminagentwithdraw/check.do"
    },
    ...
    indexInit : function (){
        ...
        $(".addbtn").live("click",function(){
            window.location.href = ctx + "/adminagentwithdraw/jumpAdd.do";
        });
        ...
        $("#edit").live("click",function(){
            ...
            $.ajax({url : ctx+ "/adminagentwithdraw/getId.do",
                type : 'post',
                dataType : 'json',
                data :{
                    id:id
