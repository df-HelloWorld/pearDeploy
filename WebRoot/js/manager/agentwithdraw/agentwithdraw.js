...
var account = {
    //地址
    url:{
        list_url : ctx + '/agentwithdraw/list.do',
        dataList_url : ctx + "/agentwithdraw/dataList.do",
        add_url : ctx+ "/agentwithdraw/add.do",
        update_url : ctx+ "/agentwithdraw/update.do",
        queryId_url: ctx+ "/agentwithdraw/getId.do",
        delete_url: ctx+ "/agentwithdraw/delete.do",
        manyOperation_url: ctx+ "/agentwithdraw/manyOperation.do"
    },
    //列表显示参数
    list:[
        {"data":"agentName",},
    ...
    indexInit : function (){
        ...
        $(".addbtn").live("click",function(){
            window.location.href = ctx + "/agentwithdraw/jumpAdd.do";
        });
    ...
    queryBankAll:function(){
        var url = basePath + "agentbank/dataAllList.do";
        var data = {
        };
        common.ajax(url,data,function(data){
            var dataList=data;
            var shtml="";
            shtml += "<select id='agentBankId' name='agentBankId'  class='text-input medium-input'>";
