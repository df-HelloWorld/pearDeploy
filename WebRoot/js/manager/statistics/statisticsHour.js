...
var account = {
    //地址
    url:{
        list_url : ctx + '/statisticsHour/list.do',
        dataList_url : ctx + "/statisticsHour/dataList.do",
        add_url : ctx+ "/statisticsHour/add.do",
        update_url : ctx+ "/statisticsHour/update.do",
        queryId_url: ctx+ "/statisticsHour/getId.do",
        delete_url: ctx+ "/statisticsHour/delete.do",
        manyOperation_url: ctx+ "/statisticsHour/manyOperation.do"
    },
    //列表显示参数
    list:[
        {"data":"curhour",},
    ...
    //查询所有订单汇总数据
    queryTotal:function(){
        var url = basePath + "statisticsHour/totalData.do";
