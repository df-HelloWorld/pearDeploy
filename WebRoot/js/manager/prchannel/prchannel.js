...
var account = {
    //地址
    url:{
        list_url : ctx + '/prchannel/list.do',
        dataList_url : ctx + "/prchannel/dataList.do",
        add_url : ctx+ "/prchannel/add.do",
        update_url : ctx+ "/prchannel/update.do",
        queryId_url: ctx+ "/prchannel/getId.do",
        delete_url: ctx+ "/prchannel/delete.do",
        manyOperation_url: ctx+ "/prchannel/manyOperation.do"
    },
    //列表显示参数
    list:[
        {"data":"gewayName",},
    ...
    indexInit : function (){
        ...
        $(".addbtn").live("click",function(){
            window.location.href = ctx + "/prchannel/jumpAdd.do";
        });
